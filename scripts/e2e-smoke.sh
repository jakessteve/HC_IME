...
grep -q '^Configurable=True$' "$DESTDIR_PATH/usr/share/fcitx5/inputmethod/hcime-telex.conf"
grep -q '^Configurable=True$' "$DESTDIR_PATH/usr/share/fcitx5/inputmethod/hcime-vni.conf"
grep -q '^Configurable=True$' "$DESTDIR_PATH/usr/share/fcitx5/inputmethod/hcime-viqr.conf"
...
grep -a -q 'Legacy tone placement' "$ADDON"
grep -a -q 'Spell check' "$ADDON"
grep -a -q 'Auto restore' "$ADDON"
grep -a -q 'Underline preedit' "$ADDON"
